# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 18:35:27 2022
...
train = pd.read_json("C:/Users/kiit/Downloads/train.json")
train.sort_values('cuisine')['cuisine'].drop_duplicates().reset_index(drop = True)

a_array= np.array(train['ingredients'])
